...
def display_diagnosis_summary(diagnosis_result: Dict):
...
def display_detailed_analysis(diagnosis_result: Dict):
...
def generate_excel_report(diagnosis_result: Dict) -> pd.DataFrame:
