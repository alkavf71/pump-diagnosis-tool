...
def render_vibration_input(section_name: str, key_prefix: str) -> Dict:
...
def render_operational_input() -> Dict:
...
def render_electrical_input() -> Dict:
