...
def prioritize_diagnosis(
    ...
    Priority order:
    1. Hydraulic (cavitation can cause false mechanical symptoms)
    ...
    if sorted_issues:
        ...
        # Special case: If hydraulic issue detected, mechanical symptoms likely secondary
...
def generate_action_plan(
    ...
    if primary_type == "NORMAL":
        ...
        if report["cavitation_risk"] == "HIGH":
            risk_score = risk_factor * 5  # Max risk for cavitation + volatile product
            risk_level = "CRITICAL"
...
def generate_summary(diagnosis_result: Dict, action_plan: Dict) -> Dict:
